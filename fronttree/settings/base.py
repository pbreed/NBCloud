# Django settings for fronttree project.

# Common settings and globals.

import os, sys
import fronttree as project_module
...
SECRET_KEY = 'c(7=3xd6#5#+_n7f2c*il!8#rxf=b(_++r&!=-msb5fo7epu#%'
...
ROOT_URLCONF = 'fronttree.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fronttree.wsgi.application'
